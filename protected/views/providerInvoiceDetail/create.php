...
/* @var $filterModel ProviderInvoiceDetail */

$this->breadcrumbs=array(
	Yii::t('app','general.label.Provider Invoice Details'),
...
$this->menu=array(
	...
	array('label'=>Yii::t('app','general.label.Receive'), 'url'=>array('/ProviderInvoice/loadStock','id'=>$model->provider_invoice)),
);
?>

<?php
	if (Yii::app()->user->checkAccess('ProviderInvoiceDetail.Create')
		|| Yii::app()->user->checkAccess('ProviderInvoiceDetail.*')) 
		echo $this->renderPartial('_form', array('model'=>$model)); 
?>

<?php 
	if (Yii::app()->user->checkAccess('ProviderInvoiceDetail.Admin')
		|| Yii::app()->user->checkAccess('ProviderInvoiceDetail.*')) 
