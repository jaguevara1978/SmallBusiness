...
/* @var $filterModel ClientInvoiceDeposit */

$this->breadcrumbs=array(
	Yii::t('app','general.label.Client Invoice Deposits'),
...
<?php
	if (Yii::app()->user->checkAccess('ClientInvoiceDeposit.Create')
		|| Yii::app()->user->checkAccess('ClientInvoiceDeposit.*')) 
		echo $this->renderPartial('_form', array('model'=>$model)); 
?>

<?php 
	if (Yii::app()->user->checkAccess('ClientInvoiceDeposit.Admin')
		|| Yii::app()->user->checkAccess('ClientInvoiceDeposit.*')) 
